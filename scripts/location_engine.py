...
def detect_location(title, description="", source=""):
    ...
    explicit=any(contains_word(t,x) for x in ["jawa timur","jatim","polda jatim","polda jawa timur"])
