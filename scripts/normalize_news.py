...
ENGINE_VERSION = "normalizer-v6.5.2"
...
def classify_existing(item):
    ...
    item.update({
        ...
        "discovery_tags": tags,
        "discovery_hits": hits,
        "discovery_version": "discovery-v6.5.2",
    })
    return item
...
def main():
    ...
    db["classifier_version"] = "news-v6.5.2"
    db["analysis_engine_version"] = "analysis-v6.5.2"
    ...
    print("========================================")
    print("JAGAT NORMALISASI V6.5.2")
    print("========================================")
